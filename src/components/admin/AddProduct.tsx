...
import ButtonAuthThema from "../styleComponents/ButtonAuthThema";
import FormGroupThema from "../styleComponents/FormGroupThema";
import LinearProgressThema from "../styleComponents/LinearProgressThema";
      ...
      <form onSubmit={detectForm(id, addProduct, editProduct)}>
        <FormGroupThema
          ...
          <TextareaAutosize
            ...
            onChange={(e) => handleInputChange(e)}
          />
          <ButtonAuthThema variant="contained" type="submit">
